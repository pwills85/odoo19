...
""",
    ...
    'data': [
        ...
        # ⭐ VISTAS PRIMERO (definen actions que serán referenciadas por menús)
        ...
        # Wizards
        # 'wizards/dte_generate_wizard_views.xml',  # ⭐ TEMPORALMENTE DESACTIVADO (requiere dte_type en account.move)
        'wizards/ai_chat_wizard_views.xml',       # ⭐ AI Chat Assistant
