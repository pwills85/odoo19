...
>
> **NO USAN:**
> - ❌ Boletas 39 (Boleta Electrónica)
> - ❌ Boletas 41 (Boleta Exenta)
> - ❌ BHE 70 (Boleta Honorarios Electrónica)
>
> **USAN PRINCIPALMENTE:**
...
### Prioridad P1 - IMPORTANTES (2 features)

| # | Feature | Razón Business | Componentes | Días | Inversión |
|---|---------|----------------|-------------|------|-----------|
| 2 | **Libro Honorarios (50)** | Compliance legal | Odoo + DTE | 5 | $1,500 |
| 3 | **RCV Automático** | Declaración mensual SII | Odoo + DTE + AI | 10 | $3,000 |

**Detalle Libro Honorarios:**
- Requerido por ley para liquidaciones 34
...
|---|---------|-------------------|--------|
| ❌ | **Boletas 39/41** | NO es retail, NO usa boletas | $1,500 |
| ❌ | **BHE 70** | NO usa boletas honorarios | $900 |
