...
class DTECompany(models.Model):
    ...
    dte_email = fields.Char(
            string='DTE Email',
            related='partner_id.dte_email', readonly=False,
    )
...
stamp to be legally valid.''',
    ...
    responsability_id = fields.Many2one(
            related='partner_id.responsability_id', readonly=False,
            relation='sii.responsability',
            string="Responsability",
            default=lambda self: self._get_default_tp_type(),
        )
    start_date = fields.Date(
            related='partner_id.start_date', readonly=False,
 ...
 will depend in partner and company responsability and SII letters\
    ...
    activity_description = fields.Many2one(
            string='Glosa Giro',
            related='partner_id.activity_description', readonly=False,
    ...
    document_number = fields.Char(
            related='partner_id.document_number', readonly=False,
            string="Document Number",
            required=True,
        )
    document_type_id = fields.Many2one(
            related="partner_id.document_type_id", readonly=False,
